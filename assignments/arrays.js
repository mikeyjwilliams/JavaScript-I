...
//console.log(`Car id ${car33.id} is a ${car33.car_make} ${car33.car_model} ${car33.car_year}.`);
...
// -> extra credit .forEach method
// let sort = inventory.forEach(function (cars) {
//     carModels.push(cars.car_model);
// });
